...
Original file is located at
    https://colab.research.google.com/drive/10KR1BOqXDwqAer3RSH4ztXLNWzWiIJfd
"""
...
def solution_B5():
    ...
    with open('daily-max-temperatures.csv') as csvfile:
        ...
        step = 0
        for row in reader:
            temps.append(float(row[1]))  # Convert temperature to float
            time_step.append(row[0])
            step = step + 1

    series = np.array(temps, dtype=float)  # Create NumPy array
